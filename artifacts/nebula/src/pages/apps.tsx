...
const APPS = [
  ...
  { id: "reddit", name: "Reddit", desc: "The front page of the internet", url: "https://reddit.com", color: "from-orange-500 to-amber-500" },
  { id: "twitter", name: "X / Twitter", desc: "Social networking", url: "https://x.com", color: "from-slate-800 to-slate-900" },
  { id: "github", name: "GitHub", desc: "Code hosting platform", url: "https://github.com", color: "from-neutral-800 to-stone-900" },
  { id: "discord", name: "Discord", desc: "Chat for communities", url: "https://discord.com", color: "from-indigo-500 to-violet-500" },
  ...
  { id: "spotify", name: "Spotify", desc: "Music streaming", url: "https://open.spotify.com", color: "from-green-500 to-emerald-500" },
  { id: "twitch", name: "Twitch", desc: "Live streaming platform", url: "https://twitch.tv", color: "from-purple-600 to-violet-500" },
  { id: "tiktok", name: "TikTok", desc: "Short-form videos", url: "https://tiktok.com", color: "from-pink-500 to-cyan-400" },
  ...
  { id: "canva", name: "Canva", desc: "Graphic design platform", url: "https://canva.com", color: "from-cyan-500 to-purple-500" },
  { id: "figma", name: "Figma", desc: "Collaborative interface design", url: "https://figma.com", color: "from-rose-400 to-violet-500" },
